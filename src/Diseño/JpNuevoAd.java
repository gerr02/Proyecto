 ...
 * @author pieri
 */
public class JpNuevoAd extends javax.swing.JPanel {
    AdmiDAO A1 = new AdmiDAO();

    /**
     * Creates new form JpNuevoAd
     */
    public JpNuevoAd() {
        initComponents();
        Limpiar();
    ...
    public void ValidarTodo(){
        ...
        //Validando Apellidos
        if (!Letras(txtApellidos.getText())) {
            lblApellidos.setText("*");
        } else {
            lblApellidos.setText("");
        }
    ...
    private void initComponents() {
        ...
        add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 290, 160, -1));

        jLabel17.setBackground(new java.awt.Color(51, 51, 51));
        jLabel17.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(0, 102, 102));
        jLabel17.setText("Nombres:");
        add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 170, -1, -1));

        jLabel2.setBackground(new java.awt.Color(51, 51, 51));
        jLabel2.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 102, 102));
        jLabel2.setText("DNI:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, 33, -1));
        ...
        add(txtNombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 170, 170, -1));

        lblError.setBackground(new java.awt.Color(51, 51, 51));
        lblError.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblError.setForeground(new java.awt.Color(255, 0, 0));
        add(lblError, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, 230, 20));
        ...
        add(txtContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, -1, -1));
        ...
        add(txtDirecc, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 250, 160, 20));

        jLabel15.setBackground(new java.awt.Color(51, 51, 51));
        jLabel15.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 102, 102));
        jLabel15.setText("Celular:");
        add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, -1, -1));

        lblCel.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblCel.setForeground(new java.awt.Color(255, 0, 0));
        add(lblCel, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 250, 20, 20));
        ...
        add(txtCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 250, 180, -1));
        ...
        lblApellidos.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblApellidos.setForeground(new java.awt.Color(255, 0, 0));
        add(lblApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 20, 20));

        lblUsuario.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblUsuario.setForeground(new java.awt.Color(255, 0, 0));
        add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 30, 20));

        lblDni.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblDni.setForeground(new java.awt.Color(255, 0, 0));
        add(lblDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 20, -1));

        lblDirecc.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblDirecc.setForeground(new java.awt.Color(255, 0, 0));
        add(lblDirecc, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 20, 20));

        lblNombres.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblNombres.setForeground(new java.awt.Color(255, 0, 0));
        add(lblNombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 160, 20, 20));

        lblContraseña.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblContraseña.setForeground(new java.awt.Color(255, 0, 0));
        add(lblContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 290, 20, 20));

        lblEmail.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        lblEmail.setForeground(new java.awt.Color(255, 0, 0));
        add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 210, 20, 20));
        ...
        add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 250, -1, -1));
        ...
        add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, -1, 20));

        btnVaciar1.setBackground(new java.awt.Color(0, 102, 102));
        btnVaciar1.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        btnVaciar1.setForeground(new java.awt.Color(255, 255, 255));
        btnVaciar1.setText("Vaciar");
        btnVaciar1.setFocusPainted(false);
        btnVaciar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVaciar1ActionPerformed(evt);
            }
        });
        add(btnVaciar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 370, 150, 30));
        ...
        add(txtDNI, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 190, -1));
        ...
        add(txtContra, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 290, 160, -1));

        jLabel9.setBackground(new java.awt.Color(51, 51, 51));
        jLabel9.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setText("Usuario:");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 290, -1, -1));
        ...
        add(txtApellidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 210, 160, -1));

        jLabel16.setBackground(new java.awt.Color(51, 51, 51));
        jLabel16.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 102, 102));
        jLabel16.setText("Email:");
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 210, -1, -1));
        ...
        add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 210, 190, -1));
    ...
    private void txtDNIKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDNIKeyReleased
        ...
        ValidarVacios();
        try {
            if(A1.Busqueda(txtDNI.getText())==1){
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try{
            A1.registrar(cod,Dni,nombre,apellidos,contra,email,cel,direcc);
