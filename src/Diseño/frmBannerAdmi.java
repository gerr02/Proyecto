 ...
 * @author pieri
 */
public class frmBannerAdmi extends javax.swing.JFrame {
    JpNuevoAd agregar =  new JpNuevoAd();
    EditarAd editar = new EditarAd();
    JpEliminarAd eliminar= new JpEliminarAd();
    JpTablaAd tablas = new JpTablaAd();
    

    /**
     * Creates new form frmBannerAdmi
     */
    public frmBannerAdmi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnTablas, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 10, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBannerAdmi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmBannerAdmi().setVisible(true);
            }
        });
    }
